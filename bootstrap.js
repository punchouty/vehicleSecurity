...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "GpsTracker.controller.AccountController": [],
  "GpsTracker.controller.SettingsController": [],
  "GpsTracker.model.Device": [],
  "GpsTracker.model.ForgotPassword": [],
  "GpsTracker.model.LoginCredential": [],
  "GpsTracker.model.Route": [],
  "GpsTracker.model.Vehicle": [],
  "GpsTracker.store.Routes": [],
  ...
  "GpsTracker.view.DeviceForm": [],
  "GpsTracker.view.ForgotPasswordForm": [],
  "GpsTracker.view.LoginForm": [],
  "GpsTracker.view.MainNavigationView": [],
  "GpsTracker.view.MainTrackForm": [],
  "GpsTracker.view.RouteForm": [],
  "GpsTracker.view.RoutePanel": [],
  "GpsTracker.view.SuperNavigationView": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "GpsTracker.util.LoginHelper": [],
  "GpsTracker.view.AdminNavigationView": [
    "widget.adminNavigationView"
  ],
  "GpsTracker.view.DeviceForm": [
    "widget.newDeviceForm"
  ],
  "GpsTracker.view.ForgotPasswordForm": [
